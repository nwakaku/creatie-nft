export const idlFactory = ({ IDL }) => {
  ...
  const Profile = IDL.Service({
    ...
    getAllProfile: IDL.Func([IDL.Nat, IDL.Nat], [IDL.Vec(IDL.Tuple(IDL.Principal, AccInfo__1))], ['query']),
    ...
    getUserName: IDL.Func([IDL.Vec(IDL.Principal)], [IDL.Vec(IDL.Opt(IDL.Text))], ['query']),
    getUserRewardsPoints: IDL.Func([IDL.Principal], [IDL.Nat], ['query']),
    increaseUserRewardsPoints: IDL.Func([IDL.Vec(UserRewardsPoints)], [CommonResponse], []),
    listTopPonits: IDL.Func([IDL.Nat], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
