export const idlFactory = ({ IDL }) => {
  ...
  const Token = IDL.Service({
    ...
    getHistoryStorageCanisterId: IDL.Func([], [IDL.Vec(IDL.Principal)], ['query']),
    ...
    getMintInfoByHeightArr: IDL.Func([IDL.Vec(BlockHeight__1)], [IDL.Vec(BlockHeight__1)], ['query']),
    ...
    getWithDrawIndex: IDL.Func([], [IDL.Nat], ['query']),
    ...
    getWithDrawRecordSize: IDL.Func([], [IDL.Nat], ['query']),
    historySize: IDL.Func([], [IDL.Nat], ['query']),
    logo: IDL.Func([], [IDL.Text], ['query']),
    mint: IDL.Func([IDL.Principal, IDL.Nat], [TxReceipt], []),
    mintFree: IDL.Func([], [TxReceipt], []),
    ...
    updateWithDrawIndex: IDL.Func([], [IDL.Bool], []),
