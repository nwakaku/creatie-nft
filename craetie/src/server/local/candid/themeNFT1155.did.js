export const idlFactory = ({ IDL }) => {
  ...
  const ThemeNFT1155 = IDL.Service({
    ...
    balanceOfByIndex: IDL.Func([IDL.Principal, TokenIndex], [Rights], ['query']),
    ...
    getAllMultipCanvas: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, IDL.Principal))], ['query']),
    getAllNFT: IDL.Func([IDL.Principal], [IDL.Vec(IDL.Tuple(CanvasIdentity, Rights))], ['query']),
    ...
    getListings: IDL.Func([TokenIndex], [IDL.Vec(IDL.Tuple(ListKey, Listings1155))], ['query']),
    getMaxOrderSize: IDL.Func([], [IDL.Nat], ['query']),
    getMultipCanvasSizes: IDL.Func([], [IDL.Nat], ['query']),
    getNFTByIndex: IDL.Func([TokenIndex], [IDL.Opt(IDL.Principal)], ['query']),
    getStorageCanisterId: IDL.Func([], [IDL.Opt(IDL.Principal)], ['query']),
    getTokenInfoByIndex: IDL.Func([TokenIndex], [IDL.Nat, IDL.Nat], ['query']),
    ...
    mintTheme1155Canvas: IDL.Func([MintThemeRequest], [CreateCanvasResponse], []),
    ...
    setNftOwner: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], [IDL.Bool], []),
    ...
    transferFrom: IDL.Func([IDL.Principal, IDL.Principal, TokenIndex, IDL.Nat], [TransferResponse], []),
