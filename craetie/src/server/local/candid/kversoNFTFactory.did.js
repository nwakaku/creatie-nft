export const idlFactory = ({ IDL }) => {
  ...
  const NFT = IDL.Service({
    ...
    getLinkInfoByIndex: IDL.Func([TokenIndex__1], [IDL.Opt(IDL.Text), IDL.Opt(IDL.Text)], ['query']),
    getLinkInfoByIndexArr: IDL.Func([IDL.Vec(TokenIndex__1)], [IDL.Vec(IDL.Tuple(IDL.Opt(IDL.Text), IDL.Opt(IDL.Text)))], ['query']),
    getListings: IDL.Func([], [IDL.Vec(IDL.Tuple(NFTStoreInfo, GetListingsRes))], ['query']),
    getListingsByAttr: IDL.Func([IDL.Vec(AttrStru)], [IDL.Vec(IDL.Tuple(NFTStoreInfo, Listings))], ['query']),
    ...
    getWhiteListPrice: IDL.Func([IDL.Principal], [IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat))], ['query']),
