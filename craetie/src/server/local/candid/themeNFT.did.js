export const idlFactory = ({ IDL }) => {
  ...
  const ThemeNFT = IDL.Service({
    ...
    getAllMultipCanvas: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex__1, IDL.Principal))], ['query']),
    ...
    getListings: IDL.Func([], [IDL.Vec(IDL.Tuple(CanvasIdentity, Listings))], ['query']),
    getMarketFeeRatio: IDL.Func([], [IDL.Nat], ['query']),
    getMultiFee: IDL.Func([], [IDL.Nat], ['query']),
    getMultipCanvasSizes: IDL.Func([], [IDL.Nat], ['query']),
    getNFTByIndex: IDL.Func([TokenIndex__1], [IDL.Opt(IDL.Principal)], ['query']),
    getRecentFinshed: IDL.Func([], [IDL.Vec(CanvasIdentity)], ['query']),
    getSoldListings: IDL.Func([], [IDL.Vec(IDL.Tuple(CanvasIdentity, SoldListings))], ['query']),
    ...
    mintThemeCanvas: IDL.Func([MintThemeRequest], [CreateCanvasResponse], []),
