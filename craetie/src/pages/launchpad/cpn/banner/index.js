  ...
  return (
    <div className="launchpad-banner-wrapper" style={{ height: `${bannerHeight}px` }}>
      <div className="blur-bg" style={{ height: `${bannerHeight}px` }}>
        <img
          src={`${ProtocolUrl}/resource/${item.key}/figure.png`}
          style={{
            height: '80%',
            filter: 'blur(20px)',
            marginLeft: '6%',
      ...
      <div className="mint-content">
        <div className="left">
          <img alt="" src={`${ProtocolUrl}/resource/${item.key}/planet.png`}></img>
        </div>
        <div className="right">
          <h3 className="title">{collectionItem?.title}</h3>
          <div className="tip description limit-lines" style={{ '--lines': 4 }} dangerouslySetInnerHTML={{ __html: collectionItem?.blurb }}></div>
