...
function BuyContent(props) {
  ...
  const handlerBuy = async () => {
    let limit = wicpBalance < multiBigNumber(unitPrice, buyCount || 0);
    if (limit) {
    ...
    <DialogBoxWrapper>
      <M1155BuyContentWrapper>
        ...
        <div className="content">
          ...
          <div className="zombie-info">
            ...
            <div className="owner">
              ...
              />
              <Input style={{ width: '200px' }} value={buyCount} className="ant-input-violet input-radius" onChange={(e) => handleSetSellAmount(e)} />
            ...
            <div className="owner">
              ...
              <div className="flex1">
                ...
                <WICPPrice iconSize={20} value={wicpBalance} valueStyle={wicpBalance < multiBigNumber(unitPrice, buyCount || 0) ? 'value-red-20' : 'value-20'} />
              </div>
            </div>
          </div>
        </div>
        <div className="button-layout">
          ...
          <Button type="violet" className="btn-small" disabled={wicpBalance < multiBigNumber(unitPrice, buyCount || 0) || !buyCount} onClick={handlerBuy}>
            Payment
          </Button>
        </div>
        {showRechage && (
