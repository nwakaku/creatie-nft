...
function SellPage(props) {
  ...
  return (
    <div className="sell-detail-wrapper">
      <div className="sell-top-title-wrapper">
      ...
      <div className="sell-content-wrapper">
        <div className="sell-detail-left">
          <div className="headline headline-000">Sales confirmation</div>
          <div className="tip tip-000 margin-20">Sales volume</div>
          <Input type="number" placeholder="Amount" className="ant-input-white input-radius4 ant-input-fixed-height margin-10" value={sellAmount} onChange={(e) => handleSetSellAmount(e)} />
          ...
          <div className="margin-10 float-right">
            <Input type="number" placeholder="price" className="ant-input-white input-radius4 ant-input-fixed-height" value={sellPrice} onChange={(e) => handleSetSellPrice(e)} />
          ...
          <div className="value value-666 float-right margin-10">
            <WICPPrice iconSize={20} value={multiBigNumber(getValueMultiplied8(sellPrice || 0), sellAmount || 0)}></WICPPrice>
            {`Total: `}
          </div>
        ...
        <div className="sell-detail-right">
          <div className="tip tip-000">Preview</div>
          <div className="pixel-content">
            <div className="canvas-pixel" ref={pixParent}>
              {canvasInfo.canisterId && <PixelThumb scale={scale} prinId={canvasPrinId} type={type} canvasInfo={canvasInfo} />}
            </div>
            <div className="info">
