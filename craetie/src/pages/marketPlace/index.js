...
function MarketPlace(props) {
  ...
  const [selectTab, setSelectTab] = useState(find(marketMenuConfig, { key: initSelect }) || marketMenuConfig[0]);
  ...
  const marketMenu = <MarketMenu MenuConfig={getCurrentMenu()} currKey={selectTab.key} currentItemKey={'marketSelected'} mode={'horizontal'} handlerItemSelect={handlerItemSelect} />;
