    ...
    return (
      <div>
        <Upload beforeUpload={this.beforeUpload} showUploadList={false}>
          ...
          {/* <img alt=""src={this.state.cropCanvas || avator} style={{ width: this.props.width + 'px' }}></img> */}
        </Upload>
        <ConfirmModal title={title} width={428} onModalClose={this.onCloseModal} onModalConfirm={this.saveImg} modalVisible={visible}>
          {srcCropper ? (
            <Cropper
              ref={(cropper) => {
