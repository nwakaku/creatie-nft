...
const AuthDrawer = memo((props: propsType) => {
      ...
      <div className="wallet-header">
        {isAuth && isAuthTokenEffect(isAuth, authToken) ? (
          <div>
            ...
            <div className="flex-10 small-tip small-tip-6D7278 margin-10">
              <div>Principal ID: </div>
              <CSCopy value={authToken} suffixCount={10} className="small-tip small-tip-6D7278" />
            </div>
            <div className="flex-10 small-tip small-tip-6D7278 margin-5">
              <div>Account ID: </div>
              <CSCopy value={principalToAccountId(Principal.fromText(authToken))} suffixCount={10} className="small-tip small-tip-6D7278" />
            </div>
          </div>
        ) : (
          <>
