...
export const isCanvas = (type) => {
  return type === CrowdCreate || type === M1155Create || type === AloneCreate || type === Theme1155Create || type === ThemeCreate;
};
export const ProtocolUrl = isTestNet ? 'https://testnet.c3-protocol.art' : 'https://market.c3-protocol.art';
