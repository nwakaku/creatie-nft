          ...
          <div className="top-wrapper">
            <div className="top-left">
              ...
              <div className="description ">
                <div className="limit-lines tip tip-000" style={{ '--lines': 5 }} dangerouslySetInnerHTML={{ __html: collectionItem?.blurb }}></div>
              </div>
            ...
            <div className="top-right">
              <img
                alt=""
                src={`${ProtocolUrl}/resource/${key}/launchpad_thumb.png`}
                onError={(e) => {
                  e.target.src = `${ProtocolUrl}/resource/${key}/thumb.png`;
                }}
              ></img>
              <div className="progress-layout">{supplyCount > 0 && <Progress percentageNum={mintCount} allNum={supplyCount} />}</div>
            </div>
          </div>
        </div>
      </div>
