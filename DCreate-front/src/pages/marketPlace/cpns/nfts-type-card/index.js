...
import { ProtocolUrl, CollectionType } from '@/constants';
    ...
    >
      <div className="image-content">
        <div className="image-thumb">
          <Image className="image-thumb-img" src={item.thumb || `${ProtocolUrl}/resource/${item.key}/thumb.png`} placeholder={<Skeleton.Image />} preview={false}></Image>
        </div>
        <div className="content1 vertical-center flex-10">
          <div className="avator-img">
            <Image className="avator-img-img" src={item.avatar || `${ProtocolUrl}/resource/${item.key}/avatar.png`} placeholder={<Skeleton.Image />} preview={false} />
          </div>
          <div className="nft-title-line">
            <div className="small-title small-title-000 nft-title">
              {item.title}
              {item.collectionType === CollectionType.CollectionFork && <div className="nft-forkable">Fork</div>}
            </div>
          </div>
