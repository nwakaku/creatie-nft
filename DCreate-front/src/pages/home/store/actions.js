...
import { getNFTListingInfo, getRecentFinishedCanvas, getNFTDetailInfo, factoryGetListingsByType, getNFTOwnersSize, getNTFCirculation, getNFTTotalSupply, getBlindTime } from '@/api/nftHandler';
...
import { getMyCollection, getCreateCollectionInfo, getMarketCollection, getPubCollection, getNFTMetaDataByIndex, getCollectionConfigParam } from '@/api/createHandler';
...
export const saveNFTInfo = (dispatch, data) => {
...
export const getCreateCollectionSettings = (type) => {
  return (dispatch) => {
    //发送网络请求
    requestCanister(
...
export const getCollectionDetailInfo = (type) => {
  return (dispatch) => {
    //发送网络请求
    requestCanister(
