export const idlFactory = ({ IDL }) => {
  ...
  const PubNFTMetaData = IDL.Record({
  ...
  const PubNFTMetaData__1 = IDL.Record({
    photoLink: IDL.Opt(IDL.Text),
    creator: IDL.Principal,
    desc: IDL.Text,
    name: IDL.Text,
  ...
  const CreatorPubNFTMetaData = IDL.Record({
    metaData: PubNFTMetaData__1,
    owner: IDL.Opt(IDL.Principal),
  });
  const AttrStru = IDL.Record({ attrIds: IDL.Vec(IDL.Nat) });
  const PubColSettings = IDL.Record({
  ...
  const PubNFT = IDL.Service({
    ...
    getAllNFT: IDL.Func([IDL.Principal], [IDL.Vec(PubNFTMetaData)], ['query']),
    getAllSaleRecord: IDL.Func([], [IDL.Vec(SaleRecord)], ['query']),
    getAllToken: IDL.Func([], [IDL.Vec(IDL.Tuple(PubNFTMetaData, IDL.Opt(Listings)))], ['query']),
    ...
    getCreatorNFT: IDL.Func([IDL.Principal], [IDL.Vec(CreatorPubNFTMetaData)], ['query']),
    getCycles: IDL.Func([], [IDL.Nat], ['query']),
    getFeeTo: IDL.Func([], [IDL.Principal], ['query']),
    getHistory: IDL.Func([TokenIndex__1], [IDL.Vec(OpRecord)], ['query']),
    getListings: IDL.Func([], [IDL.Vec(IDL.Tuple(PubNFTMetaData, Listings))], ['query']),
    getListingsByAttr: IDL.Func([IDL.Vec(AttrStru)], [IDL.Vec(IDL.Tuple(PubNFTMetaData, Listings))], ['query']),
    getNFTMetaDataByIndex: IDL.Func([TokenIndex__1], [IDL.Opt(PubNFTMetaData)], ['query']),
    getOwner: IDL.Func([], [IDL.Principal], ['query']),
    getOwnerSize: IDL.Func([], [IDL.Nat], ['query']),
    getSaleRecordByAccount: IDL.Func([IDL.Principal], [IDL.Vec(SaleRecord)], ['query']),
    getSettings: IDL.Func([], [PubColSettings], ['query']),
    getSoldListings: IDL.Func([], [IDL.Vec(IDL.Tuple(PubNFTMetaData, SoldListings))], ['query']),
    ...
    uploadIPFSItem: IDL.Func([NewPubItem], [MintResponse], []),
