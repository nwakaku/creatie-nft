export const idlFactory = ({ IDL }) => {
  ...
  const ThemeCanvas = IDL.Service({
    ...
    getAllAccChangeNums: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
    ...
    getAllPixel: IDL.Func([], [IDL.Vec(IDL.Tuple(Position__1, PixelInfo))], ['query']),
    ...
    getHighestPosition: IDL.Func([], [IDL.Opt(IDL.Tuple(Position__1, Pixel))], ['query']),
