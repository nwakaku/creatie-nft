export const idlFactory = ({ IDL }) => {
  ...
  const Result_11 = IDL.Variant({
    ok: IDL.Tuple(Properties, IDL.Vec(IDL.Tuple(IDL.Text, IDL.Int)), IDL.Vec(IDL.Tuple(IDL.Text, IDL.Principal, IDL.Nat))),
    err: Error__1,
  });
  ...
  const Hub = IDL.Service({
    ...
    batchTransferFrom: IDL.Func([IDL.Principal, IDL.Vec(IDL.Principal), IDL.Vec(TokenIndex__1)], [TransferResponse__1], []),
    ...
    getEntries: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Tuple(IDL.Opt(IDL.Principal), IDL.Vec(IDL.Principal)), Token__1))], ['query']),
