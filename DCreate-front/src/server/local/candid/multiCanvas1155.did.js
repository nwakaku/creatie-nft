export const idlFactory = ({ IDL }) => {
  ...
  const MultiCanvas = IDL.Service({
    ...
    drawPixel: IDL.Func([IDL.Vec(DrawPosRequest), IDL.Opt(IDL.Text)], [DrawResponse], []),
    fixAccPixelNums: IDL.Func([], [IDL.Bool], []),
    getAccInfo: IDL.Func([], [AccInfo], ['query']),
    getAccInfo2: IDL.Func([IDL.Principal], [AccInfo], ['query']),
    getAllAccPixelNums: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
    getAllIncome: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, Asset))], ['query']),
    getAllPixel: IDL.Func([], [IDL.Vec(IDL.Tuple(Position, PixelInfo))], ['query']),
    ...
    getHighestPosition: IDL.Func([], [IDL.Opt(IDL.Tuple(Position, Pixel))], ['query']),
    ...
    getUserBonusByIndexs: IDL.Func([IDL.Principal], [IDL.Vec(IDL.Tuple(TokenIndex, IDL.Nat))], ['query']),
