...
const cssModuleRegex = [/\.module\.css$/, /\.module\.less$/];
...
module.exports = function (webpackEnv) {
  ...
  const isProductLine = env.stringified['process.env']['DFX_NETWORK'] === 'ic_line';
  ...
  return {
      ...
      splitChunks: {
        ...
        cacheGroups: {
          ...
          antd: {
            name: 'chunk-antd',
            chunks: 'all',
            test: /[\\/]node_modules[\\/](@ant-design|antd|moment|immutable\/dist|rc-calendar\/es|braft-finder\/dist|axios|xlsx|video.js|lodash|rc-tree\/es)[\\/]/,
            priority: -11,
          },
        },
      },
    ...
    resolve: {
      ...
      alias: {
        ...
        canister: path.resolve(__dirname, '../src/server'),
